...
var downTimeEvents = __webpack_require__(17);
...
var onSignUp = function onSignUp(event) {
  ...
  api.signUp(data).then(ui.signUpSuccess).then($('#user-signup input[type="text"]').val('')).then($('#user-signup input[type="password"]').val('')).catch(ui.signUpFailure);
};

var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.signIn(data).then(ui.signInSuccess).then($('#user-signin input[type="text"]').val('')).then($('#user-signin input[type="password"]').val('')).then($('#before-signinauth').hide()).then($('#after-signinauth').show()).catch(ui.signInFailure);
...
var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.changePassword(data).then(ui.changePasswordSuccess).then($('#user-changepwd input[type="password"]').val('')).catch(ui.changePasswordFailure);
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  api.signOut().then(ui.signOutSuccess).then($('#before-signinauth').show()).then($('#after-signinauth').hide()).catch(ui.signOutFailure);
};
...
var onCreateDowntime = function onCreateDowntime(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createDowntime(data).then(ui.createDowntimeSuccess).then($('#create-downtime input[type="text"]').val('')).catch(ui.createDowntimeFailure);
};

var onGetMyDowntime = function onGetMyDowntime(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.getMyDowntime(data).then(ui.getMyDowntimeSuccess).then($('#get-downtime input[type="text"]').val('')).catch(ui.getMyDowntimeFailure);
};

var onGetAllDowntime = function onGetAllDowntime(event) {
  event.preventDefault();
  api.getAllUserDowntimes().then(ui.getAllDowntimeSuccess).catch(ui.getAllDowntimeFailure);
};

var onUpdateDowntime = function onUpdateDowntime(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.updateDowntime(data).then(ui.updateDowntimeSuccess).then($('#update-downtime input[type="text"]').val('')).catch(ui.updateDowntimeFailure);
};

var onDeleteDowntime = function onDeleteDowntime(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.deleteInstance(data).then(ui.deleteDowntimeSuccess).then($('#delete-downtime input[type="text"]').val('')).catch(ui.deleteDowntimeFailure);
};
...
var createDowntime = function createDowntime(data) {
  return $.ajax({
...
var getMyDowntime = function getMyDowntime(data) {
  return $.ajax({
...
var getAllUserDowntimes = function getAllUserDowntimes() {
  return $.ajax({
    url: config.apiOrigin + '/downtime_instances',
    method: 'GET',
    headers: {
...
var updateDowntime = function updateDowntime(data) {
  return $.ajax({
    url: config.apiOrigin + '/downtime_instances/' + data.downtime_instance.id,
    method: 'PATCH',
    headers: {
...
var deleteInstance = function deleteInstance(data) {
  return $.ajax({
    url: config.apiOrigin + '/downtime_instances/' + data.downtime_instance.id,
    method: 'DELETE',
    headers: {
...
module.exports = {
  createDowntime: createDowntime,
  getMyDowntime: getMyDowntime,
  getAllUserDowntimes: getAllUserDowntimes,
...
var store = __webpack_require__(3);
var showInstanceTemplate = __webpack_require__(20);
var showInstanceAllTemplate = __webpack_require__(37);

var createDowntimeSuccess = function createDowntimeSuccess(data) {
...
var createDowntimeFailure = function createDowntimeFailure(error) {
  $('#create-message').text('Error On New Downtime');
  $('#create-message').css('background-color', 'red');
  console.log(error);
};

var getMyDowntimeSuccess = function getMyDowntimeSuccess(data) {
  $('#get-message').text('Downtime Instance Received');
  $('#get-message').css('background-color', 'green');
  store.downtime_instance = data.downtime_instance;
  var showInstanceHtml = showInstanceTemplate({ downtime_instance: data.downtime_instance });
  $('.downtime-content').append(showInstanceHtml);
};

var getMyDowntimeFailure = function getMyDowntimeFailure(error) {
  $('#get-message').text('Error Retrieving Instance');
  $('#get-message').css('background-color', 'red');
  console.log(error);
};

var getAllDowntimeSuccess = function getAllDowntimeSuccess(data) {
  $('#get-message').text('All Downtime Instances Received');
  $('#get-message').css('background-color', 'green');
  console.log('data in getAllDowntimeSuccess events is ', data);
  var showInstanceAllHtml = showInstanceAllTemplate({ downtime_instances: data.downtime_instances });
  $('.alldowntime-content').append(showInstanceAllHtml);
};

var getAllDowntimeFailure = function getAllDowntimeFailure(error) {
  $('#get-message').text('Error Retrieving Instance');
  $('#get-message').css('background-color', 'red');
  console.log(error);
};

var updateDowntimeSuccess = function updateDowntimeSuccess(data) {
  $('#update-message').text('Instance Updated Successfully');
  $('#update-message').css('background-color', 'green');
};

var updateDowntimeFailure = function updateDowntimeFailure(error) {
  $('#update-message').text('Error on Update');
  $('#update-message').css('background-color', 'red');
  console.log(error);
};

var deleteDowntimeSuccess = function deleteDowntimeSuccess() {
  $('#delete-message').text('Instance Deleted Successfully');
  $('#delete-message').css('background-color', 'green');
};

var deleteDowntimeFailure = function deleteDowntimeFailure(error) {
...
module.exports = {
  createDowntimeSuccess: createDowntimeSuccess,
  createDowntimeFailure: createDowntimeFailure,
  getMyDowntimeSuccess: getMyDowntimeSuccess,
  getMyDowntimeFailure: getMyDowntimeFailure,
  getAllDowntimeSuccess: getAllDowntimeSuccess,
  getAllDowntimeFailure: getAllDowntimeFailure,
  updateDowntimeSuccess: updateDowntimeSuccess,
  updateDowntimeFailure: updateDowntimeFailure,
  deleteDowntimeSuccess: deleteDowntimeSuccess,
  deleteDowntimeFailure: deleteDowntimeFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      Date: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.date : stack1), depth0))
    + "\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "      No date recorded. You should update this.\n";
},"5":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "      Time: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.time : stack1), depth0))
    + "\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "      No time recorded. You should update this.\n";
},"9":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "      Activity: "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.activity : stack1), depth0))
    + "\n";
},"11":function(container,depth0,helpers,partials,data) {
    return "      No activity recorded.  We assume you were fighting aliens.\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression, alias3=depth0 != null ? depth0 : (container.nullContext || {});

  return "\n<!--data.downtime_instance.id\n    data.downtime_instance.activity\n    data.downtime_instance.date\n    data.downtime_instance.time\n-->\n  <!--USE HANDLEBARS FOR LAYOUT-where jQuery, Javascript, etc. -->\n  <!-- Use it to make a truly single single-page app, hide and format!!-->\n  <!-- Helps you do the same thing in HTML to every element via EACH -->\n <!-- Developers, why are we using data-id and not just id? -->\n<div data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">\n  <h3>Downtime Instance #"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.id : stack1), depth0))
    + "</h3>\n  <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.activity : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
    + "  </p>\n  <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.activity : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "")
    + "  </p>\n  <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = (depth0 != null ? depth0.downtime_instance : depth0)) != null ? stack1.activity : stack1),{"name":"if","hash":{},"fn":container.program(9, data, 0),"inverse":container.program(11, data, 0),"data":data})) != null ? stack1 : "")
    + "  </p>\n</div>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</h3>\n  <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.activity : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </p>\n  <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.activity : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </p>\n  <p>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.activity : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </p>\n</div>\n\n";
  ...
  return "      Activity: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.activity : stack1), depth0))
    + "\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.downtime_instances : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
